    ...
    <section className='relative'>
      ...
      <div className='container px-4 mx-auto min-h-screen flex flex-col lg:flex-row items-center py-12'>
        ...
        <div className='border border-gray w-full lg:px-24 lg:pt-16 lg:pb-20 px-8 py-10 bg-white z-10 rounded-3xl shadow-lg'>
          ...
          {step === 3 && <Form3 setData={nextStep} point={point} data={data} back={back} />}
          {step === 4 && <Form4 setData={nextStep} point={point} data={data} back={back} />}
          {step === 5 && <Form5 setData={nextStep} point={point} data={data} back={back} />}
          {step === 6 && <Form6 setData={nextStep} point={point} data={data} back={back} />}
          {step === 7 && <Form7 setData={nextStep} point={point} data={data} back={back} />}
          {step === 8 && <Form8 setData={nextStep} point={point} data={data} back={back} />}
          {step === 9 && <Form9 setData={nextStep} point={point} data={data} back={back} />}
          {step === 10 && <Form10 setData={nextStep} point={point} data={data} back={back} />}
          {step === 11 && <Form11 setData={nextStep} point={point} data={data} back={back} />}
          {step === 12 && <Form12 setData={nextStep} point={point} data={data} back={back} />}
          {step === 13 && <Form13 setData={nextStep} point={point} data={data} back={back} />}
          {step === 14 && <Form14 setData={nextStep} point={point} data={data} back={back} />}
          {step === 15 && <Form15 setData={nextStep} point={point} data={data} back={back} />}
        </div>
      </div>
    </section>
  );
